...
# root_lidar_path = '/home/yinhuan/Data/radar_lidar_pr/Oxford/seq01_80/lidar_sc_density/'
root_lidar_path = '/home/yinhuan/Data/radar_lidar_pr/Oxford/seq01_80/lidar_sc_occupy/'

save_radar_feature_path = '/home/yinhuan/Data/radar_lidar_pr/Oxford/seq01_80/radar_feature_joint/'
save_lidar_feature_path = '/home/yinhuan/Data/radar_lidar_pr/Oxford/seq01_80/lidar_feature_joint/'


save_radar_fft_path = '/home/yinhuan/Data/radar_lidar_pr/Oxford/seq01_80/radar_fft_joint/'
save_lidar_fft_path = '/home/yinhuan/Data/radar_lidar_pr/Oxford/seq01_80/lidar_fft_joint/'
...
if __name__ == "__main__":
    ...
    for iter_ in range(start_id, end_id):
            ...
            # save txt
            if not os.path.exists(save_radar_feature_path):
                os.makedirs(save_radar_feature_path)
            if not os.path.exists(save_lidar_feature_path):
                os.makedirs(save_lidar_feature_path)
            ...
            radar_feature_np = radar_feature.view(SC_H, SC_W).detach().cpu().numpy()
            with open(save_radar_feature_path + str(iter_+1) + '.txt', 'wb') as f:
                np.savetxt(f, radar_feature_np, fmt='%5.5f', delimiter=' ', newline='\n')

            lidar_feature_np = lidar_feature.view(SC_H, SC_W).detach().cpu().numpy()
            with open(save_lidar_feature_path + str(iter_+1) + '.txt', 'wb') as f:
                np.savetxt(f, lidar_feature_np, fmt='%5.5f', delimiter=' ', newline='\n')
