function [ img ] = Ptcloud2ScanContext_occupy( ptcloud, num_sector, num_ring, max_range )
...
min_num_thres = 3; % a bin with few points, we consider it is noise.
...
for ith_ring = 1:num_ring
    for ith_sector = 1:num_sector
        ...
        points_in_bin_ij = cell_bin_counter(ith_ring, ith_sector);
        
        if points_in_bin_ij > min_num_thres && ith_ring >= 3
            img(ith_ring, ith_sector) = 1; 
        end
    end
end
